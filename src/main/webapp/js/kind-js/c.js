			...
			var e = {
				...
				$oojs: function() {
					...
					if("undefined" != typeof window && window && "undefined" != typeof document && document ? (this.runtime = "browser",
							e.global = window) : (this.runtime = "node",
							e.global = t),
						e.proxyName = "proxy",
						e.path = "node" === this.runtime ? process.cwd() + "/src/" : "/src/",
						"undefined" != typeof o)
						for(var i in o)
							i && o.hasOwnProperty(i) && (e[i] = o[i]);
				...
				setPath: function(t, e) {
					...
					if("object" != typeof t) {
						if(e)
							for(var n = t.split("."), o = 0, s = n.length; s > o; o++) {
					...
					for(var o in i)
						if(i.hasOwnProperty(o) && i[o]) {
							...
							if("string" != typeof i[o] ? (t[o] = i[o],
									t[o] && t[o].__name && (s = t[o].__full)) : (s = i[o],
									t[o] = this.find(s)), !s || e[s])
								continue;
							if(e[s] = !0,
								t[o])
				...
				define: function(t) {
					...
					t.__name = e,
						...
						t.__constructor = function(t, e, i, n, o) {
							if(this.__clones && this.__clones.length > 0)
								for(var s = 0, r = this.__clones.length; r > s; s++) {
					...
					for(var n, o = !1, s = !1, r = i.split("."), a = r.length, d = this.classes, l = 0; a > l; l++)
						n = r[l],
						n && (d[n] = d[n] || {},
							d = d[n]);
					d[e] = d[e] || {};
					...
					if(d = d[e],
						...
						if(d.__registed) {
							o = !0;
							for(var h in t)
								h && t.hasOwnProperty(h) && ("undefined" == typeof d[h] || d[h] === this.noop) && (s = !0,
									d[h] = t[h])
						}
					} else
						t.__registed = !0,
					...
					if(t = c[e], !o || s) {
						...
						if(u.length > 0) {
							if(this.loader = this.loader || this.using("oojs.loader"),
								...
								throw new Error('class "' + t.name + "\" loadDeps error:" + u.join(","));
		...
		s.setPath('https://dup.baidustatic.com/'),
			...
			s.define({
				...
				checkBrowser: function() {
					...
					for(var n = ["Android", "iPad", "iPod", "iPhone", "iOS", "Linux", "Macintosh", "Windows"], o = ["iPad", "iPhone", "iOS", "iPod"], s = "", r = 0; r < n.length; r++)
						if(s = n[r],
							...
							for(var n = 30; n >= 2; n--)
								try {
									...
									if(o) {
										...
										if(t = s.replace(/WIN/g, "").replace(/,/g, "."),
											t > 0)
											break
									}
								} catch(r) {}
			...
			s.define({
				...
				tactics: function() {
					...
					t < 1e6 * this.config.SHUNT_NUMBER ? (this.config.EXP_SATUS = !0,
						this.config.EXP_ID = this.config.RD_ID) : t >= 1e6 * this.config.SHUNT_NUMBER && t < 1e6 * this.config.SHUNT_NUMBER * 2 && (this.config.EXP_ID = this.config.BASE_ID)
				}
			}),
			s.define({
				name: "material",
			...
			s.define({
				...
				ready: function(t, e, i) {
					...
					var o = s.proxy(this, function() {
							...
							else if("complete" === n.readyState || this.domContentLoaded)
								t = !0;
							else if(this.domReadyMonitorRunTimes > 3e5)
								return void(this.domReadyMonitorId && (i.clearInterval(this.domReadyMonitorId),
									this.domReadyMonitorId = null));
							if(t)
								try {
									if(this.readyFuncArray && this.readyFuncArray.length)
										for(var s = 0, r = this.readyFuncArray.length; r > s; s++) {
											var a = this.readyFuncArray[s];
											a && a.func && !a.done && (a.delay ? (a.done = !0,
												i.setTimeout(a.func, a.delay)) : (a.done = !0,
												a.func()))
										}
								} catch(d) {
									throw d
								} finally {
									this.domReadyMonitorId && (i.clearInterval(this.domReadyMonitorId),
										this.domReadyMonitorId = null)
								}
						}, this),
						r = s.proxy(this, function() {
							this.domContentLoaded = !0,
								o()
						});
					this.domReadyMonitorId || (this.domReadyMonitorId = i.setInterval(o, 50),
						n.addEventListener ? (n.addEventListener("DOMContentLoaded", r, !1),
							i.addEventListener("load", r, !1)) : n.attachEvent && i.attachEvent("onload", r, !1))
				},
				bind: function(t, e, i) {
			...
			s.define({
				...
				getVisibility: function(t) {
					...
					for(var o = 0, s = 10; o++ < s && this.dom.isInIframe(i) && !this.dom.isInCrossDomainIframe(i) && i.frameElement;) {
						if(n = this.getVisibilityInWin(i.frameElement), !n)
							return !1;
						i = i.parent
					}
					return !0
			...
			s.define({
				...
				queryToJson: function(t) {
					for(var e, i, n, o, s = t.substr(t.indexOf("?") + 1), r = s.split("&"), a = r.length, d = {}, l = 0; a > l; l++)
						o = r[l].split("="),
						e = o[0],
						i = o[1],
						n = d[e],
			...
			s.define({
				...
				putConfig: function(t, e) {
					return t && e ? (this.pageInfo = this.getInfo("pageConfig") || {},
						this.pageInfo[t] = e,
						this.putInfo("pageConfig", this.pageInfo), !0) : !1
				}
			}),
			s.define({
				name: "origentation",
				...
				saveOrientation: function(t, e, i) {
					...
					var n = i.merge ? this.data.getInfo(this.orientKey) : {},
						...
						r = {};
					for(var a in s)
						this.hasOwn.call(s, a) && (r[a] = "array" === this.lang.getType(s[a]) ? s[a].slice() : s[a]);
					for(var d = r[t] || [], l = e.length, c = 0; l > c; c++) {
						var h = e[c];
						"string" == typeof h && (h = encodeURIComponent(h),
							h.length <= 100 && (d[d.length] = h))
					}
					return d.length ? (r[t] = this.lang.unique(d),
						this.data.putInfo(o, r), !0) : !1
				},
				getOrientationQuery: function(t) {
					...
					for(var s = "", r = i.length, a = 0; r > a && !(s.length + i[a].length >= t); a++)
						s += (a ? "&" : "") + i[a];
					return s
				},
			...
			s.define({
				...
				assert: function(t) {
					...
					i && "encoded" === i && (e = decodeURIComponent(e),
						t.response.placement.userdefine = e);
			...
			s.define({
				...
				getSlotType: function(t) {
					...
					if((this.inlayFixAssert.assert(i) || this.dynamicFloatAssert.assert(i)) && (e = this.TYPE.INLAY),
						n && n.fillstyle)
						for(var o = i.placement.fillstyle.elements || [], s = 0, r = o.length; r > s; s++)
							if(5 === o[s])
			...
			s.define({
				...
				activate: function(t) {
					return this.validate(t) ? (this.expansionActionName = "BaiduCproExpansion" + t.containerId,
						...
						this.dom.bind(window, "message", s.proxy(this, this.onPostMessageHandler)), !0) : !1
				},
				validate: function(t) {
			...
			s.define({
				...
				onScrollHandler: function() {
					...
					this.totalScrollLength += e - this.lastScrollTop,
						...
						"top" === i && !this.close4ever && Math.abs(this.totalScrollLength) >= t && !this.countDownTimerId ? (this.expandAd(),
							this.startCountDown(this.autoCloseTime, s.proxy(this, this.onTimeCountDownHandler))) : "down" === i && (this.totalScrollLength = 0)
				},
			...
			s.define({
				...
				getPainter: function(t) {
					if(t.response) {
						...
						for(var i = t.response, n = ["bottomSearchBar", "inlayFix", "baiduRec", "dynamicFloat", "insideText", "mobile.inlayFix", "mobile.float"], o = 0, r = n.length; r > o; o++) {
							var a = s.using("dup.ui.assertion." + n[o]);
							if(a && a.assert(i))
								return "dup.ui.painter." + n[o]
						}
						e || (t.errors = t.errors || [],
				...
				getParamObj: function(t) {
					...
					if(this.browser.baiduboxapp) {
						...
						r.articleTitle && (i.ti = r.articleTitle),
							r.MP && r.MP.globalConf && (i.utdi = encodeURIComponent(window.MP.globalConf.cuid) || "",
			...
			s.define({
				...
				adSlotFinish: function(t) {
					...
					if(n.response) {
						...
						for(var s in this.origentation.watchingSlotsMap)
							if(s && this.origentation.watchingSlotsMap.hasOwnProperty(s) && this.origentation.watchingSlotsMap[s] && 0 === ("" + t).indexOf("" + s) && n.response) {
								var r = o.deliv_des,
									a = r.width || 0,
									d = r.height || 0;
								0 === a || 0 === d ? e[t] = !1 : e[t] = !0,
				...
				requestSlotInfo: function(t) {
					this.config.FIRST_ONCESEACH || (this.config.FIRST_ONCESEACH = !0,
						this.dom.bind(window, "message", s.proxy(this, this.onMessageHandler)));
					var e = !1;
					...
					t.posUrl && (this.browser.antBrowser || t.proxy) ? (t.paramObj.ctxant = "1",
							i = this.param.getParamString(t.paramObj),
							n = t.posUrl + i) : (i = this.param.getParamString(t.paramObj),
					...
					"union" === t.productLine && (o = !0),
						...
						e ? (this.setStatus(t.id, this.config.STATUS_REQUEST),
							window[this.config.LOADER_DEFINE_NAME](e)) : (this.sendJsonpRequest(n, o),
				...
				onMessageHandler: function(t) {
					...
					if(e && e.tuid) {
						var i = t.origin || t.originalEvent.origin,
							n = i && i.split("//")[1],
							o = t.source;
						if(e.placement && e.placement.update && e.queryid)
							this.updateInfo(e),
				...
				processSlotInfo: function(t) {
					...
					if(t.styleOpenApi) {
						...
						var u = c.cpro_w || c.rsi0 || 0,
							p = c.cpro_h || c.rsi1 || 0;
						(u || p) && (r = 1,
							a = u || this.getCurViewportWidth(a),
							d = p || d)
					}
					return("-1" === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (r = "-1" === t.pcwd && "-1" === t.pchd ? 8 : 5),
						1 === r ? e = {
							...
							d = t.pchd || d,
							e = this.param.translateScaleToPixelSize(a, d)) : 3 === r ? e = {
							width: this.getCurViewportWidth(a),
							height: d
						} : 5 === r || 6 === r ? (e.width = l.width,
							e.height = 6 === r ? d : Math.ceil(e.width / a * d)) : 7 === r ? e = {
							height: l.width || 0,
							width: a
						} : 8 === r && (e = {
							width: l.width || 0,
			...
			s.define({
					...
					if(e) {
						...
						if(window.postMessage && c.slotId && c.slotId.indexOf("u") > -1) {
							c.sendMessage = function() {
								if(this.watchIframeWindow && this.watchIframeLoaded && this.viewContext && this.viewContext.lastAdViewStatus !== this.viewContext.currAdViewStatus)
									try {
							...
							if(h && h.length) {
								...
								c.viewContext.lastAdViewStatus = !1,
									...
									this.dom.bind(c.watchIframe, "load", function() {
				...
				updateViewStatus: function(t, e) {
					...
					return i = n = o = this.intervalTimeSpan,
						...
						t.currViewStatus ? (this.intervalStatus === this.STATUS.LOAD && (i = parseInt(a.getTime() - t.inViewTimeStamp.getTime(), 10),
							...
							t.inViewTime += i,
							t.inViewTimeStamp = a) : s && (t.inViewTimeStamp = a),
						t.currViewStatus = s,
						t.currAdViewStatus ? (this.intervalStatus === this.STATUS.UNLOAD && (o = parseInt(a.getTime() - t.adViewTimeStamp.getTime(), 10),
							...
							t.adViewTime += o,
							t.adViewTimeStamp = a) : r && (t.adViewTimeStamp = a),
				...
				viewableCompute: function() {
					if(this.watchingList)
						for(i = 0,
							count = this.watchingList.length; i < count; i++) {
				...
				windowOnLoadDelay: function(t) {
					...
					for(e = 0,
						...
						n && (s = n.domId,
							s && (o = this.win.document.getElementById(s)),
				...
				registerFocusEvent: function(t) {
					var t = t || this.win;
					this.winFocused = !0,
						this.browser.ie ? (this.dom.bind(t, "focusin", s.proxy(this, this.allDomOnFocusHandler)),
							this.dom.bind(t, "focusout", s.proxy(this, this.allDomOnBlurHandler))) : (this.dom.bind(t, "focus", s.proxy(this, this.allDomOnFocusHandler)),
							this.dom.bind(t, "blur", s.proxy(this, this.allDomOnBlurHandler)))
				},
				...
				launch: function() {
					...
					if(window.cpro_mobile_slot = null,
						...
						for(var n = 0, o = s.length; o > n; n++) {
							...
							for(var a in r)
								a && r[a] && r.hasOwnProperty(a) && (t.styleOpenApi[a] = r[a]);
							this.slot.addSlot(t)
						}
					this.slot.process()
				}
					...
					for(var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
						...
						if(n.hasOwnProperty("id")) {
							...
							if(n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async),
								...
								t.pchd = n.pchd || "",
								t.proxy = n.proxy || "",
								t.exps = n.exps || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
								var s, r = n.size;
								if(r && r.indexOf(":") > -1) {
									s = r.split(":");
			...
			s.define({
				...
				expandAd: function(t) {
					if(!this.expandStatus[t]) {
						...
						if(1 === c || 2 === c ? (p.setAttribute("height", a),
								p.style.height = a + "px") : 3 !== c && 4 !== c || (p.setAttribute("width", r),
								p.style.width = r + "px"),
							2 == l && 2 == c || 2 == l && 4 == c)
							switch(c) {
								case 2:
							...
							switch(u.style.position = "relative",
			...
			s.define({
				...
				cacheRequestCallback: function(t) {
					...
					if("success" !== e) {
						...
						if(0 === parseInt(r.deliv_id, 10) && (0 !== parseInt(d.deliv_id, 10) || 0 !== parseInt(a.deliv_id, 10)) && "success" !== e && 7 === o.placement.complement_type) {
							...
							return l && (this.viewWatch.unregisetViewWatch(i),
									l.parentNode.removeChild(l)),
								c && c.parentNode.removeChild(c),
								void(h && h.parentNode.removeChild(h))
						}
						if(i)
							if(n.type && "rich" === n.type) {
				...
				requireDomainPolicy: function() {
					...
					var e = document.createElement("iframe"),
						i = !1;
					return document.body ? (e.src = "about:blank",
			...
			s.define({
				...
				render: function(t, e) {
					try {
						...
						if(!e && (!o || "rich" !== o.type || s))
							return !1;
						var r = o.content
					} catch(a) {}
					if(!t.isAsync && !s)
						return document.write(r),
							this.slot.setStatus(t.id, this.config.STATUS_FINISH), !0;
					...
					for(var c = d.childNodes, h = [], u = 0; c[u]; u++)
						!this.isNeededNode(c[u], "script") || c[u].type && "text/javascript" !== c[u].type.toLowerCase() || h.push(c[u]);
					h.reverse();
					for(var p = 0, m = h.length; m > p; p++)
						this.evalScript(h[p].parentNode.removeChild(h[p]), d);
					return !0
				}
			}),
			s.define({
				...
				updatePosition: function(t, e) {
					...
					if(i) {
						var n = i.style,
							...
							a = (r.clientWidth,
								r.clientHeight),
							d = (window.pageXOffset || r.scrollLeft,
					...
					if(e) {
						...
						if(this.decorateContainer(e, o),
							...
							if(s && s._html) {
								s = s._html;
								var r = s.type;
								"text" !== r && "image" !== r && "flash" !== r || (s.width = t.width,
									s.height = t.height)
							}
						}
						var a = {
							...
							if(n && (t.width = e.width,
								...
								if(2 === e.sizeType) {
									...
									if(r && r._html) {
										r = r._html;
										var a = r.type;
										"text" !== a && "image" !== a && "flash" !== a || (r.width = t.width,
											r.height = t.height)
									}
								}
								var d = {
					...
					try {
						...
						window.BAIDU_CLB_SLOT_ID = null,
							e && (t = this.slot.createSlot({
								...
								this.slot.addSlot(t),
								this.slot.process());
						for(var i in this.clbSlotArr)
							"BAIDU_CLB_preloadSlots" === i ? this.data.defineOnce(i, s.proxy(this, this.reSet)) : this.data.defineOnce(i, s.proxy(this, this.getClbFillSlot));
						this.updateApi()
					} catch(n) {}
				},
				reSet: function() {},
			...
			s.define({
				...
				render: function(t) {
					...
					var e = this.dom.g(t.containerId);
					if(!this.slot.adInfoIsAvailable(t))
						return this.slot.setStatus(t.id, this.config.STATUS_FINISH), !1;
					t.displayType = "inlay";
			...
			s.define({
				...
				callback: function(t) {
					try {
						...
						if(!e || e.containerId && !this.dom.g(e.containerId))
							return;
						e.response = t,
				...
				painterLoadedCallback: function(t, e, i) {
					var n = i || s.using(t);
					n && (n.render(e),
						t && t.indexOf("mobile") > -1 && (this.viewWatch.regisetViewWatch(e),
							this.fingerPrint.loadAntiBotFile()),
						this.sendPVLog())
				},
				sendPVLog: function() {
